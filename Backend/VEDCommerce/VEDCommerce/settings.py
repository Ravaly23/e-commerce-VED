"""
Django settings for VEDCommerce project.
...
SECRET_KEY = 'django-insecure-tncehz5yzcwc5_*r_(=&=mufta14j=^$e@sw2(1czzbo9$0b+='
...
WSGI_APPLICATION = 'VEDCommerce.wsgi.application'
