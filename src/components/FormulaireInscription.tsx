...
import { FaCheckCircle, FaEnvelope, FaExclamationTriangle, FaEye, FaEyeSlash, FaLock } from "react-icons/fa"
...
export default function FormulaireInscription() {
    ...
    const [isVisibleIconVerification, setIsVisibleIconVerification] = useState(false)
    const [iconVerification, setIconVerification] = useState(<FaExclamationTriangle />)
    ...
    return (
        <div className="m-10 lg:px-15 lg:mx-25">
            ...
            <Input
                ...
                marginBottom="36px"
            />
            <p className="pl-2.5 font-bold mb-[10px] text-white">Confirm your password</p>
            <Input
